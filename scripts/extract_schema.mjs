 ...
 * Connection — pick one
 * ---------------------
 *   (Note: For Supabase, it is highly recommended to use the connection pooler URL 
 *    with session mode, e.g., postgresql://postgres.[project-ref]:[password]@aws-0-[region].pooler.supabase.com:5432/postgres)
 *
 *   Option 1 — .env file
