...
export function OAuthButtons() {
    ...
    return (
        <div className="grid gap-2">
            <Button variant="outline" type="button" disabled={oauthLogin.isPending} onClick={() => handleLogin('google')}>
                {oauthLogin.isPending ? (
                    <span className="me-2 h-4 w-4 animate-spin rounded-full border-2 border-primary border-t-transparent" />
                ) : (
                    <svg className="me-2 h-4 w-4" aria-hidden="true" focusable="false" data-prefix="fab" data-icon="google" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 488 512">
