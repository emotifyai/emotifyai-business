...
export const mockSubscriptions: Record<SubscriptionTier, Subscription> = {
    ...
    [SubscriptionTier.SMALL_BUNDLE]: {
        id: 'sub-small-bundle-123',
        user_id: mockUser.id,
        created_at: '2024-11-15T10:00:00Z',
        updated_at: '2024-11-27T12:00:00Z',
        lemon_squeezy_id: 'ls_sub_small_bundle_123',
        status: SubscriptionStatus.ACTIVE,
        tier: SubscriptionTier.SMALL_BUNDLE,
        current_period_start: '2024-11-15T10:00:00Z',
        current_period_end: '2025-11-15T10:00:00Z',
        cancel_at: null,
        trial_started_at: null,
        trial_expires_at: null,
        monthly_quota: 100,
        quota_used_this_month: 20,
        quota_reset_at: '2025-11-15T10:00:00Z',
        cache_enabled: true,
        tier_name: 'Small Bundle',
        credits_limit: 100,
        credits_used: 20,
        credits_reset_date: '2025-11-15T10:00:00Z',
        validity_days: 365,
    },
    [SubscriptionTier.LARGE_BUNDLE]: {
        id: 'sub-large-bundle-123',
        user_id: mockUser.id,
        created_at: '2024-11-10T10:00:00Z',
        updated_at: '2024-11-27T12:00:00Z',
        lemon_squeezy_id: 'ls_sub_large_bundle_123',
        status: SubscriptionStatus.ACTIVE,
        tier: SubscriptionTier.LARGE_BUNDLE,
        current_period_start: '2024-11-10T10:00:00Z',
        current_period_end: '2025-11-10T10:00:00Z',
        cancel_at: null,
        trial_started_at: null,
        trial_expires_at: null,
        monthly_quota: 500,
        quota_used_this_month: 80,
        quota_reset_at: '2025-11-10T10:00:00Z',
        cache_enabled: true,
        tier_name: 'Large Bundle',
        credits_limit: 500,
        credits_used: 80,
        credits_reset_date: '2025-11-10T10:00:00Z',
        validity_days: 365,
    },
}
